  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-8 border-b border-blue-500/20 pb-6 mb-8">
        <div>
          <h1 className="text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-sky-600 pb-2">
            Market Analytics
          </h1>
          ...
          {popularPairs.map(pair => (
            <button
              ...
              className={`px-4 py-2 rounded-xl text-sm font-bold whitespace-nowrap transition-all ${
                symbol === pair.symbol 
                ? "bg-blue-500 text-white shadow-[0_0_15px_rgba(99,102,241,0.4)]" 
