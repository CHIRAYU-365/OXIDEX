  ...
  useEffect(() => {
    const fetchStats = async () => {
      try {
        ...
        const usersRes = await fetch(`${import.meta.env.VITE_BACKEND_URL || 'https://oxidex-api.onrender.com'}/api/admin/users?limit=10`, {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-white/5 backdrop-blur-xl p-8 rounded-2xl border border-white/10 shadow-[0_0_15px_rgba(245,158,11,0.05)]">
        <h2 className="text-2xl font-bold mb-6 text-white">Recent Users (Latest 10)</h2>
        {loading ? (
